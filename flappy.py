...
def draw_window(screen, birds, pipes, base, score, birdcount, gen):
  ...
  score_text = STAT_FONT.render("Score: " + str(score), 1, (0,0,255))
  birds_text = STAT_FONT.render("Birds: " + str(len(birdcount)), 1, (255,0,0))
  gen_text = STAT_FONT.render("Generation: " + str(gen), 1, (255,0,0))
  screen.blit(score_text, (screen_width - 10 - score_text.get_width(), 10))
  screen.blit(birds_text, (5, 10))
  screen.blit(gen_text, (5, 40))
...
def main(genomes, config):
  ...
  while run:
    ...
    base.move()
    draw_window(screen, birds, pipes, base, score, birds, generation_count)
